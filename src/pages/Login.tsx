      ...
      <div className="flex-1 flex items-center justify-center medical-gradient p-4">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold font-heading text-primary-foreground">Medical Caravan</h1>
            <p className="text-primary-foreground/80 mt-2 font-body">Clinic Management System</p>
          </div>
